                ...
                <main className="flex-1 flex flex-col overflow-y-auto">
                    ...
                    <header className="bg-white shadow-sm px-4 md:px-8 py-4 flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                            ...
                            <h2 className="text-lg md:text-xl font-semibold text-gray-800">Category Management</h2>
                        </div>
                        <div className="flex items-center space-x-4">
                                    ...
                                    <table className="w-full text-left">
                                        <thead className="bg-gray-50">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase">Created Date</th>
